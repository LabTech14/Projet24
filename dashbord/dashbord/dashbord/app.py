...
# Chemin du répertoire contenant les fichiers Excel Inventaires

input_directory = r'input'

######################################## La lecture des données financières ############################################


fina = pd.read_csv(r'non.csv')


############################################## Exploration et Traitements des données du fichier Analyse TB2023 #####################################
...
# Supprimer des colonnes  sans valeurs ajoutées telsque "Unnamed: 25", "JOURS" et "TOTAL DEPENSES "
